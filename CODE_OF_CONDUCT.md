...
Examples of representation include using an official email address, posting
...
repository's **private security advisory channel** (see `SECURITY.md`) or by
opening an issue marked `[CONDUCT]`; a maintainer will respond privately.
...
and an explanation of why the behavior was inappropriate. A public apology may
be requested.
...
### 4. Permanent Ban
**Community Impact**: A pattern of violation, sustained harassment, or
